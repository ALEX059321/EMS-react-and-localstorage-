  ...
  return (
    <div className="w-full max-w-md p-6 bg-neutral-secondary-soft border border-border-default rounded-lg shadow-xl backdrop-blur-md relative overflow-hidden transition-all duration-300 hover:shadow-brand/10 hover:border-brand/30">
      ...
      <div className="mb-8 text-center">
        <h2 className="text-3xl font-extrabold text-text-heading tracking-tight">Register</h2>
      </div>
      ...
      <form className="space-y-5" onSubmit={handleSubmit} >
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 bg-neutral-primary border border-border-default rounded-md text-text-heading placeholder-text-body/50 focus:outline-none focus:ring-2 focus:ring-brand/50 focus:border-brand transition-all duration-200"
            required
